      ...
      return (
        <div className="min-h-screen pt-20 flex items-center justify-center">
          <div className="text-center glass-panel max-w-md">
            ...
            <Link to={"/products"}
            className="inline-flex items-center space-x-2 px-6 py-3 rounded-lg text-primary-foreground gradient-primary hove:glow-on-hover animate-smooth font-semibold">
                ...
                <div key={item.product.id} className="glass-card p-6">
                  <div className="flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-6">
                    ...
                    <div className="flex-1 min-w-0">
                      <Link to={`/product/${item.product.id}`}
                      className="block hover:text-primary transition-colrs">
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="flex items-center space-x-2">
                        <button disabled={item.quantity===1} onClick={()=>updateQuantity(item.product.id,item.quantity-1)}
          ...
          <div className="lg:col-span-1">
            <div className="glass-panel sticky top-24">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="border-t border-[hlsa(var(--glass-border))] pt-4">
                  <div className="flex justify-between">
