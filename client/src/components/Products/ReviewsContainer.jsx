                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-4 mb-2">
                    ...
                    <div className="flex">
                      {[...Array(5)].map((_,i)=>{
                      return (
                        <Star key={i} className={`w-4 h-4 ${i<Math.floor(review.ratings)?"text-yellow-400 fill-current":"text-gray-300"}`} />
                  ...
                  {authUser?.id===review.reviewer?.id &&(
                    <button onClick={()=>dispatch(deleteReview({productId:product.id,reviewId:review.review_id}))}
