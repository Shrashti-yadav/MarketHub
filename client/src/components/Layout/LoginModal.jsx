...
const LoginModal = () => {
  ...
  const handleSubmit=(e)=>{
    ...
    if(authUser){
      setFormData({name:"",email:"",confirmPassword:""});
    }
  };
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center">
    {/*Overlay */}
    <div className="absolute inset-0 backdrop-blur-md bg-[hlsa(var(--glass-bg))]"/>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {mode==="signup" &&(
          <div className="relative">
            ...
            }} className="w-full pl-10 pr-4 py-3 bg-secondary border border-border rounded-lg focus:otline-none" 
            required></input>
          </div>
        )}
        {/*EMAIL-LAWAYS EXCEPT RESET MODE */}
        {mode!=="reset" &&(
          <div className="relative">
            <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-muted-foreground "/>
            <input type="email"
