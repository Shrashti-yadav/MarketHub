            ...
            <div className="glass-panel m-6 max-w-2xl mx-auto">
              ...
              <div className="relative">
                ...
                <input type="text" placeholder="Search for products.. " value={searchQuery} onChange={(e)=>
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-secondary border border-border rounded-lg focus:ouline-none text-foreground placeholder-muted-foreground" autoFocus/>
              </div>
