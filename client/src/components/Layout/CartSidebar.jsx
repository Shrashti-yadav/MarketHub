      ...
      <div className="p-6">
        {cart && cart.length===0 ?(
                ...
                <div key={item.product.id} className="glass-card p-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <button disabled={item.quantity===1} className="p-1 rounded glass-card hover:glow-on-hover animate-smooth"
                      onClick={()=>{
                        updateQuantity(
                          item.product.id,
                          item.quantity-1
                      ...
                      <button className="p-1 rounded glass-card hover:glow-on-hover animate-smooth ml-2 text-destructive" onClick={()=>{
          ...
          <div className="border-t border-[hsla(var(--glass-border))] pt-4">
            ...
            className=" py-3 w-full block text-center gradient-primary text-primary-foreground rounded-lg hover:glow-on-hover animate-smooth font-semibold">
              View Cart & Checkout
            </Link>
