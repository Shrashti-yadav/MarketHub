...
const ProfilePanel = () => {
  ...
  const handleUpdatePassword=()=>{
    ...
    if(avatar) formData.append("confirmNewPassword",confirmNewPassword);
  ...
  return (
    ...
    <div className="fixed right-0 top0 h-full w-96 z-50 glass-panel animate-slide-in-right overflow-y-auto">
      ...
      <div className="p-6">
        ...
        {authUser &&(
          <div className="space-y-4 mb-8">
            ...
            <button onClick={handleUpdateProfile} className="flex justify-center space-x-3 p-3 rounded-lg glass-card hover:glow-on-hover animate-smooth group w-full">
              {isUpdatingProfile?(
                <> 
        ...
        <div className="space-y-4 mb-8">
            ...
            <button onClick={handleUpdatePassword} className="flex justify-center space-x-3 p-3 rounded-lg glass-card hover:glow-on-hover animate-smooth group w-full">
              {isUpdatingPassword?(
                <> 
                <div className={`w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin`}/>
