...
export const getUser = () => async (dispatch) => {
  ...
  try {
    ...
    dispatch(
      authSlice.actions.getUserSuccess(res.data.user)
    );
  } catch (error) {
...
export const forgotPassword = (email) => async (dispatch) => {
  ...
  try {
    ...
    dispatch(
      authSlice.actions.forgotPasswordSuccess()
    );
    ...
    toast.error(
      error.response?.data?.message ||
        "Cannot request for reset password"
    );
  }
};
...
export const resetPassword =
  (newData, token) => async (dispatch) => {
    ...
    try {
      ...
      dispatch(
        authSlice.actions.resetPasswordSuccess(
          res.data.user
        )
      );
...
export const updateAdminProfile =
  (data) => async (dispatch) => {
    dispatch(
      authSlice.actions.updateProfileRequest()
    );
    ...
    try {
      ...
      dispatch(
        authSlice.actions.updateProfileSuccess(
          res.data.user
        )
      );
...
export const updateAdminPassword =
  (data) => async (dispatch) => {
    dispatch(
      authSlice.actions.updatePasswordRequest()
    );
    ...
    try {
      ...
      dispatch(
        authSlice.actions.updatePasswordSuccess()
      );
