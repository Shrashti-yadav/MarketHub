...
export const fetchAllUsers = (page) => async (dispatch) => {
  ...
  await axiosInstance
    ...
    .then((res) => {
      dispatch(
        adminSlice.actions.getAllUsersSuccess(res.data)
      );
    })
    .catch((error) => {
      dispatch(
...
export const deleteUser = (id, page) => async (dispatch, getState) => {
  ...
  await axiosInstance
    ...
    .catch((error) => {
      dispatch(adminSlice.actions.delelteUserFailed());
...
export const getDashboardStats = () => async (dispatch) => {
  ...
  await axiosInstance
    ...
    .then((res) => {
      dispatch(
        adminSlice.actions.getStatsSuccess(res.data)
      );
    })
    .catch((error) => {
      dispatch(
        adminSlice.actions.getStatsFailed()
      );
    });
};
