...
import {
  ...
  updateOrderStatus,
  deleteOrder,
} from "../store/slices/orderSlice"; // Adjust path if needed
                  ...
                  <div className="flex justify-between items-start flex-wrap gap-4">
                    ...
                    <div>
                      ...
                      <button
                        ...
                        className="ml-3 bg-red-500 hover:bg-red-600 text-white rounded px-3 py-1 rounded"
                      >
                        Delete
                      </button>
                    </div>
...
<div className="mt-4">
  ...
  <p>
    <strong>Qty: </strong> Qty: {item.quantity} | <strong>Price:</strong>  ${item.price} |
