                    ...
                    {products.map((product, index) => (
                      <tr key={index} className="border-t hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 flex gap-2">
                          <button
                            className="text-white rounded-md cursor-pointer px-3 py-2 font-semibold bg-green-500 hover:bg-green-600"
                            onClick={() => {
                          ...
                          <button
                            className="text-white rounded-md cursor-pointer px-3 py-2 font-semibold bg-red-500 hover:bg-red-600 flex gap-2 items-center"
                            onClick={() => {
                              dispatch(setSelectedProduct(product));
